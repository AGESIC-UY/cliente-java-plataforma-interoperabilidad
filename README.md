# cliente-java-plataforma-interoperabilidad [Sin Mantenimiento]
...
Cliente Java es una API que facilita y estandariza el uso de los servicios Web publicados en la PDI.  La solución fue desarrollada bajo Java 6, y utiliza Maven y Eclipse.
