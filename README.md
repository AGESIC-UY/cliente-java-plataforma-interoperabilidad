...
Cliente Java es una librería que facilita y estandariza el uso de los servicios Web publicados en la PDI. La solución fue desarrollada utilizando es una evolución de la versión liberada en 2013, ahora implementada con openjdk 8.
